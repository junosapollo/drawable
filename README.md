...
The code license is an open decision for the repository owner. The Milestone 1
plan calls for MIT, but the current `LICENSE` file is all-rights-reserved and
